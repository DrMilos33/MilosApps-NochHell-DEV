...
const deMessages = {
  ...
  privacyCopy:
    "Kein Tracking, keine Cookies, kein Konto und keine Koordinaten in der Seitenadresse. Nur der eingegebene Suchtext wird für Ortsvorschläge und abgesendete Suchen an Open-Meteo übertragen.",
...
const enMessages: Record<MessageKey, string> = {
  ...
  privacyCopy:
    "No tracking, cookies, account or coordinates in the page address. Only the entered search text is sent to Open-Meteo for place suggestions and submitted searches.",
