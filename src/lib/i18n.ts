...
const deMessages = {
  ...
  cancel: "Abbrechen",
  searchHint: "Neue Orte mit Enter oder Suchen finden.",
  localSuggestionsTitle: "Bekannte Orte",
...
const enMessages: Record<MessageKey, string> = {
  ...
  cancel: "Cancel",
  searchHint: "Find new places with Enter or Search.",
  localSuggestionsTitle: "Known places",
