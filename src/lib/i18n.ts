...
const deMessages = {
  ...
  cancel: "Abbrechen",
  searchHint: "Orte erscheinen ab drei Zeichen. Enter sucht genauer.",
  deviceTitle: "Gerätestandort",
  deviceCopy: "Nur nach deinem Tipp, auf etwa 1 km gerundet gespeichert.",
  locateButton: "Meinen Ort verwenden",
  ...
  privacyCopy:
    "Kein Tracking, keine Cookies, kein Konto und keine Koordinaten in der Seitenadresse. Ab drei Zeichen wird der Suchtext für Vorschläge an Open-Meteo gesendet; erst Enter oder Suchen fragt OpenStreetMap Nominatim genauer ab.",
  clearData: "Lokale Ortsdaten löschen",
  attributionPrefix: "Ortsdaten:",
  attributionName: "OpenStreetMap-Mitwirkende",
  attributionNominatimLicense: "(ODbL)",
  attributionSuggestionsName: "Open-Meteo / GeoNames",
  attributionSuffix: "(CC BY 4.0). Sonnenzeiten nach NOAA/Meeus-Näherung.",
  localTime: "Ortszeit",
  nextDayLocalTime: "Nächster Kalendertag",
  ...
  dataClearedStatus:
    "Lokale Ortsdaten gelöscht. Köln wird wieder als Standardort angezeigt.",
...
const enMessages: Record<MessageKey, string> = {
  ...
  cancel: "Cancel",
  searchHint: "Places appear after three characters. Enter searches more precisely.",
  ...
  privacyCopy:
    "No tracking, cookies, account or coordinates in the page address. From three characters, the search text is sent to Open-Meteo for suggestions; only Enter or Search asks OpenStreetMap Nominatim for a more precise search.",
  clearData: "Delete local place data",
  attributionPrefix: "Place data:",
  attributionName: "OpenStreetMap contributors",
  attributionNominatimLicense: "(ODbL)",
  attributionSuggestionsName: "Open-Meteo / GeoNames",
  attributionSuffix: "(CC BY 4.0). Sun times use a NOAA/Meeus approximation.",
  localTime: "Local time",
  nextDayLocalTime: "Next calendar day",
  ...
  dataClearedStatus:
    "Local place data deleted. Cologne is shown as the default place again.",
  online: "Back online.",
